...
const Question = ({ mongoUserId }: Props) => {
  ...
  const handleInputKeyDown = (
    ...
    if (e.key === "Enter" && field.name === "tags") {
      ...
      // this if statement suggests that the user has entered a tag but if the length of the tag is greater than 15 characters then it will throw an error.
      if (tagValue !== "") {
        ...
        // if the tag is already present in the tags array then it will throw an error.
        // then it will clear the input field and the error.
        // else it will add the tag to the tags array.
